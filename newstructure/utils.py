...
def save_fft_data(output_fft_folder, fft_data, M_loss='', pulse_type='', roll_off=''):
    """
    Save the FFT data to a file.
    
    Args:
    - fft_data (tensor): The FFT data to be saved.
    - M_loss (float): The M_loss value to include in the filename.
    - pulse_type (str): The type of the pulse (e.g., DNN, EXP, RC).
    - additional_info (str): Additional info to differentiate iterations.
    """
    save_fft_data
    ...
    filepath = os.path.join(output_fft_folder, filename)
